...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<6;i++){
            ...
            else if(enter.substring(i,7).matches(N6.substring(i,7))){
                switch (i){
            ...
            else if(enter.substring(i,7).matches(N7.substring(i,7))){
                switch (i){
            ...
            else if(enter.substring(i,7).matches(N8.substring(i,7))){
                switch (i){
